...
//			StateLabel.Text = Order.Customer.StateCode;
			...
			if (Order.PONumber != null) {
				if (Order.PONumber.Trim () == "") {
					PONumberFieldLabel.Hidden = true;
				} else {
					PONumberFieldLabel.Hidden = false;
					PONumberFieldLabel.Hidden = false;
				}

				PONumberLabel.Text = Order.PONumber;
			} else {
				PONumberLabel.Text = "";
				PONumberFieldLabel.Hidden = true;
			}
		...
		public class OrderLinesInfoSource : UITableViewSource {
			...
			public override UITableViewCell GetCell (UITableView tableView, NSIndexPath indexPath)
			{
				...
				if (orderLine.ProductName != null) {
					...
					cell.DetailTextLabel.Text = String.Format ("{1}, {2}", orderLine.ProductCode, orderLine.ProductUOM, orderLine.Quantity);
					...
					cell.DetailTextLabel.Text = String.Format ("{1}, {2}", product.Code, orderLine.ProductUOM, orderLine.Quantity);
					...
					cell.DetailTextLabel.Text = String.Format ("{1}, {2}", product[0].Code, orderLine.ProductUOM, orderLine.Quantity);
