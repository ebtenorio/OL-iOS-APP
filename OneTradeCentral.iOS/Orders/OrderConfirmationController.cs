	...
	public partial class OrderConfirmationController : UIViewController
	{
		...
		public override void ViewDidLoad ()
		{
			...
			if (Order.PONumber.Trim () == "") {
				PONumberLabel.Hidden = true;
				PONumber.Hidden = true;
			} else {
				PONumberLabel.Hidden = false;
				PONumber.Hidden = false;
				PONumber.Text = Order.PONumber;
			}
...
//			}
		...
		public class OrderLineSource: UITableViewSource
		{
			...
			public override UITableViewCell GetCell (UITableView tableView, NSIndexPath indexPath)
			{
				...
				cell.DetailTextLabel.Text =  "UOM:" +  _orderLineList [indexPath.Row].ProductUOM.ToString () + ", Quantity: " + _orderLineList [indexPath.Row].Quantity.ToString ();
				return cell;
			}
