...
namespace OneTradeCentral.iOS
{
	...
	partial class OrderViewController
	{
		...
		[Outlet]
		UIKit.UITableView EmailAddressTableView { get; set; }
		...
		[Outlet]
		UIKit.UITextField PONumberField { get; set; }
		...
		[Action ("addNewEmail:")]
		partial void addNewEmail (Foundation.NSObject sender);

		[Action ("addNewEmailAddress:")]
		partial void addNewEmailAddress (UIKit.UIButton sender);
		...
		[Action ("test:")]
		partial void test (UIKit.UIButton sender);
		...
		void ReleaseDesignerOutlets ()
		{
			...
			if (EmailAddressTableView != null) {
				EmailAddressTableView.Dispose ();
				EmailAddressTableView = null;
			}
