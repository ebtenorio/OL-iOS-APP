...
namespace OneTradeCentral.iOS
{
	...
	partial class OrderInfoViewController
	{
		...
		[Outlet]
		UIKit.UILabel PONumberFieldLabel { get; set; }

		[Outlet]
		UIKit.UILabel PONumberLabel { get; set; }
		...
		void ReleaseDesignerOutlets ()
		{
			...
			if (PONumberFieldLabel != null) {
				PONumberFieldLabel.Dispose ();
				PONumberFieldLabel = null;
			}

			if (PONumberLabel != null) {
				PONumberLabel.Dispose ();
				PONumberLabel = null;
			}
