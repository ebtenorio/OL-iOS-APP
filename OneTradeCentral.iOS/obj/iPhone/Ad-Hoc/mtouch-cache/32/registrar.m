...
static void native_to_managed_trampoline_64 (id self, SEL _cmd, MonoMethod **managed_method_ptr, UIGestureRecognizer * p0, const char *r0, const char *r1, const char *r2)
{
	MonoMethod *managed_method = *managed_method_ptr;
	void *arg_ptrs [1];
	MonoObject *mthis;
...
@implementation __UIGestureRecognizerParametrizedToken { } 
	...
	{
		static MonoMethod *managed_method = NULL;
		native_to_managed_trampoline_64 (self, _cmd, &managed_method, p0, "UIKit.UIGestureRecognizer, Xamarin.iOS", "UIKit.UIGestureRecognizer+ParametrizedDispatch, Xamarin.iOS", "Activated");
	}
@end
...
void xamarin_create_classes () {
	...
	__xamarin_class_map [28].handle = objc_getClass ("NSCalendar");
	...
	__xamarin_class_map [36].handle = objc_getClass ("UISegmentedControl");
	...
	__xamarin_class_map [57].handle = objc_getClass ("NSStringDrawingContext");
	__xamarin_class_map [58].handle = objc_getClass ("CALayer");
	...
	__xamarin_class_map [77].handle = objc_getClass ("NSDateFormatter");
	...
	__xamarin_class_map [87].handle = objc_getClass ("UIActionSheet");
	__xamarin_class_map [88].handle = objc_getClass ("UIAlertView");
	__xamarin_class_map [89].handle = objc_getClass ("NSDictionary");
	__xamarin_class_map [90].handle = objc_getClass ("NSMutableDictionary");
	__xamarin_class_map [91].handle = objc_getClass ("NSData");
	__xamarin_class_map [92].handle = objc_getClass ("UISearchBar");
	...
	__xamarin_class_map [180].handle = objc_getClass ("__UIGestureRecognizerToken");
	__xamarin_class_map [181].handle = objc_getClass ("__UIGestureRecognizerParameterlessToken");
	__xamarin_class_map [182].handle = objc_getClass ("__UIGestureRecognizerParametrizedToken");
	__xamarin_class_map [183].handle = objc_getClass ("UIKit_UIActionSheet__UIActionSheetDelegate");
	__xamarin_class_map [184].handle = objc_getClass ("UIKit_UIAlertView__UIAlertViewDelegate");
